...
## ESP32
The ESP32 folder contains the C++ code for the sender node and the receive node. MAC addresses within the code should be changed accordingly when flashing a microcontroller. These are set up for PlatformIO. They require the following libraries:
- Adafruit BusIO
- Adafruit GFX
- Adafruit MPU6050
- Adafruit SSD1306
